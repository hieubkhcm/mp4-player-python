...
##################################################################### GUI click on 
##### adding two buttons for seeking forward and backward 3 seconds
        self.ButtonSeekBack.pressed.connect(self.SeekBackPosition)
        self.ButtonSeekForth.pressed.connect(self.SeekForthPosition)
######################################################################
...
###################### Seek Function ######################
    def SeekBackPosition(self, *args):
        position = self.player.position()
        self.player.setPosition(position-5*1000)

    def SeekForthPosition(self, *args):
        position = self.player.position()
        self.player.setPosition(position+5*1000)
...
if __name__ == '__main__':
    app = QApplication([])
    app.setApplicationName("Video Preview")
    app.setStyle("Fusion")
